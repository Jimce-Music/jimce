...
/**
 * Takes a deezer metadata result (according to GenericMetadataScheme) as input and matches it to a GenericSoundScheme
 */
export async function matchDeezerMetadataToYoutubeSound(
